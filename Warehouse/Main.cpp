...
void printMenu()
{
	...
	cout << "/---------------------------------------------------------" << endl;
	cout << endl;
	cout << "To see the Warehouse inventory enter 1" << endl;
	cout << "To add a Batch to the Warehouse enter 2" << endl;
	cout << "To take Item from the inventory enter 3" << endl;
	cout << "To see the history of the Warehouse enter 4" << endl;
	cout << "To clear the Warehouse to a certain date enter 5" << endl;
	cout << "To save the warehouse to a local file enter 6" << endl;
	cout << "To load the Warehouse from a file enter 7" << endl;
	cout << "To exit the interface enter 0" << endl;
	cout << endl;
	cout << "/---------------------------------------------------------" << endl;
	cout << endl;
}
